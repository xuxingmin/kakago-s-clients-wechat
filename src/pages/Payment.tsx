          ...
          <div className="flex flex-col items-center justify-center py-20 px-8">
            ...
            <div className="w-full max-w-xs space-y-3">
              <button
                ...
                className="w-full py-3.5 rounded-2xl text-sm font-semibold bg-gradient-to-r from-primary to-accent text-oat hover:shadow-[0_0_20px_hsl(var(--copper-500)/0.25)] transition-all active:scale-[0.98]"
              >
                {t("查看订单", "View Order")}
          ...
          <div className="flex flex-col items-center justify-center py-24 px-8">
            ...
            <div className="flex gap-3 w-full max-w-xs">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-2xl text-xs font-semibold bg-gradient-to-r from-primary to-accent text-oat hover:shadow-[0_0_20px_hsl(var(--copper-500)/0.25)] transition-all"
              >
                {t("重试支付", "Retry")}
              </button>
            </div>
      ...
      {paymentState === "selecting" && (
        <div className="fixed bottom-0 left-0 right-0 z-40 glass border-t border-border safe-bottom">
          <div className="px-4 py-3 max-w-md mx-auto">
            <button
              onClick={handleConfirmPay}
              className="w-full py-3.5 rounded-2xl text-sm font-semibold flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-accent text-oat hover:shadow-[0_0_20px_hsl(var(--copper-500)/0.25)] transition-all active:scale-[0.98]"
            >
